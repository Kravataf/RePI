...
public class EntityIncompleteForm extends ElementsReParasiteInfection.ModElement {
	public static final int ENTITYID = 7;
	public static final int ENTITYID_RANGED = 8;
	public EntityIncompleteForm(ElementsReParasiteInfection instance) {
		super(instance, 13);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("reparasiteinfection", "incompleteform"), ENTITYID).name("incompleteform").tracker(64, 3, true).egg(-1, -1)
				.build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelIncompleteForm(), 0.9f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("reparasiteinfection:textures/ncompleteorm_texture_v2.png");
				}
			};
		});
	}
